...
void SoundManager::ChangeSoundEffectVolum(float volumePercents)
{
	for(int i = 0; i < volumePercents; i++)
	{
		sound[i].setVolume(volumePercents);
	}
}
void SoundManager::ChangeBackGroundMusicVolume(float volumePercents)
{
	backgroundMusic.setVolume(volumePercents);
}